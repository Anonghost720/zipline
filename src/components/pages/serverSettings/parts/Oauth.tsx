  ...
  return (
    <Paper withBorder p='sm' pos='relative'>
      ...
      <Text size='sm' c='dimmed'>
        ...
        If you have issues, try restarting ShareHost after saving.
      </Text>
      ...
      <form onSubmit={form.onSubmit(onSubmit)}>
        ...
        <Paper withBorder p='sm' my='sm'>
          ...
          <TextInput
            ...
            description='The redirect URL to use instead of the host when logging in. This is not required if the URL generated by ShareHost works as intended.'
